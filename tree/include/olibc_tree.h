...
extern olibc_retval_t olibc_tree_get_type(olibc_tree_handle handle, olibc_tree_type_t *type);
extern olibc_retval_t olibc_tree_add_data(olibc_tree_handle handle, void *data);
